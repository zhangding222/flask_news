...
class Tixian(BaseModel, db.Model):
    
    __tablename__ = "info_tixian"
    tixian = db.Column("tixian", db.Integer)  
    id =db.Column("id", db.Integer, primary_key=True)  
    user_id = db.Column("user_id", db.Integer, db.ForeignKey("info_user.id"))  
    status = db.Column("status", db.Integer)
    zhifubao = db.Column(db.String(256), nullable=False)
...
class Tuisong(BaseModel, db.Model):
    
    __tablename__ = "info_tuisong"
    id =db.Column("id", db.Integer, primary_key=True)  
    user_id = db.Column("user_id", db.Integer, db.ForeignKey("info_user.id"))  
    news_id = db.Column("news_id", db.Integer, db.ForeignKey("info_news.id"))
    tuisong = db.Column(db.String(256), nullable=False)
    def to_review_dict(self):
        resp_dict = {
            "tuisong": self.tuisong,
